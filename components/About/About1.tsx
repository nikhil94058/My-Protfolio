...
function TextDisplay() {
  const words = [
    {
      text: "Build",
      className: "text-green-500 font-bold", // Example styles
    },
    {
      text: "awesome",
...
function LampDemo() {
  ...
  const words = ["<Code />", "<div>Eat</div>","prinf(Sleep);", "<Creative />"];
  return (
    <div>
      <LampContainer>
      <motion.div
      ...
      className="text-5xl text-green-800  font-bold text-center" // Styling for the text
    >
      About Me
    </motion.div>
    <span className="text-center text-2xl text-green-800 md:text-3xl font-mono font-extrabold text-black my-4">
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic bg-gradient-to-r from-green-500 via-transparent to-transparent  text-white [--conic-position:from_70deg_at_center_top]"
        >
